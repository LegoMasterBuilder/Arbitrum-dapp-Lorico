...
import * as svelteElements from '.pnpm/svelte@4.2.18/node_modules/svelte/elements';

/**
 * @internal do not use
 */
type HTMLProps<Property extends string, Override> = Omit<
	import('.pnpm/svelte@4.2.18/node_modules/svelte/elements').SvelteHTMLElements[Property],
	keyof Override
> &
	Override;
