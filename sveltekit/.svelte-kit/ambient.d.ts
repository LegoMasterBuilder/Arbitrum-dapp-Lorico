...
declare module "$env/static/private" {
  ...
  export const npm_package_scripts_fmt_fix: string;
  ...
  export const npm_package_scripts_lint_css: string;
  export const npm_package_scripts_lint_svelte: string;
  ...
  export const npm_package_devDependencies__linthtml_linthtml: string;
  ...
  export const npm_package_devDependencies_stylelint_config_tailwindcss: string;
  ...
  export const npm_package_scripts_lint_html: string;
  ...
  export const npm_package_devDependencies_htmlnano: string;
  ...
  export const npm_package_devDependencies__linthtml_linthtml_config_recommended: string;
...
declare module "$env/dynamic/private" {
  export const env: {
    ...
    TERM_PROGRAM: string;
    npm_package_scripts_fmt_fix: string;
    ...
    npm_package_scripts_lint_css: string;
    npm_package_scripts_lint_svelte: string;
    ...
    ZDOTDIR: string;
    npm_package_devDependencies__linthtml_linthtml: string;
    ...
    npm_package_scripts_lint_html: string;
    ...
    npm_package_devDependencies_htmlnano: string;
    ...
    COLORTERM: string;
    npm_package_devDependencies__linthtml_linthtml_config_recommended: string;
