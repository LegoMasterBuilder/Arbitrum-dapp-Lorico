...
import { HMRPayload, CustomPayload } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/hmrPayload.js';
export { ConnectedPayload, CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload, PrunePayload, Update, UpdatePayload } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/hmrPayload.js';
import { InferCustomEventPayload } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/customEvent.js';
export { CustomEventMap, InferCustomEventPayload, InvalidatePayload } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/customEvent.js';
...
export { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/importGlob.js';
export { ChunkMetadata } from '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/metadata.js';
import '.pnpm/vite@5.3.1_@types+node@20.14.5_terser@5.31.1/node_modules/vite/types/hot.js';
